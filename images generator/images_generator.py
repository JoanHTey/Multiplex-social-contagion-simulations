...
# Initialize the matrix
    matrix = np.zeros((100, 6), dtype=float)
...
for i in range(10):
    ...
    for gamma in np.logspace(0,2,10):
      ...
      for p in np.logspace(-2,2,100):
        ...
        i1,i2=IPR(w)
        #v1[gamma].append(v)
        ER1i[gamma].append(i1)
        ER2i[gamma].append(i2)
        ER1[k,j]=ER1[k,j]+i1
        ER2[k,j]=ER2[k,j]+i2
        j=j+1
      k=k+1 
...
for gamma in np.logspace(0,2,10):
   if gamma!=1:
     if i<5:  
       ...
       plt.plot(np.logspace(-2,2,100)/((10*(1-(1-1/10)**(np.logspace(0,2,10)[i+1]))-8*(1-(1-1/8)**(np.logspace(0,2,10)[i+1])))),ER1[i+1],color=colors[i],linestyle='--' )
       plt.plot(np.logspace(-2,2,100)/((10*(1-(1-1/10)**(np.logspace(0,2,10)[i+1]))-8*(1-(1-1/8)**(np.logspace(0,2,10)[i+1])))),ER2[i+1],color=colors[i])  
     if 4<i:
        plt.plot(np.logspace(-2,2,100)/((10*(1-(1-1/10)**(np.logspace(0,2,10)[i+1]))-8*(1-(1-1/8)**(np.logspace(0,2,10)[i+1])))),ER1[i+1],color=colors[i],linestyle='--' )
        plt.plot(np.logspace(-2,2,100)/((10*(1-(1-1/10)**(np.logspace(0,2,10)[i+1]))-8*(1-(1-1/8)**(np.logspace(0,2,10)[i+1])))),ER2[i+1],label=r'$\gamma$'+'='+str(int(gamma*100)/100),color=colors[i])
     i=i+1
